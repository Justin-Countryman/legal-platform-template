...
export type ContentSectionInline = {
  ...
  showPhone?: boolean;
  media?: Media;
  imageTreatment?: "inherit" | "plain" | "framed" | "slab" | "scrim" | "tint";
  marquee?: boolean;
...
export type AttorneySectionInline = {
  ...
  layout?: "grid" | "slider";
  cardStyle?:
    "inherit" | "classic" | "portrait" | "avatar" | "minimal" | "spotlight";
  surface?: "light" | "tint" | "dark" | "image" | "pattern";
  sectionBackgroundImage?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
...
export type ContentSection = {
  ...
  imageTreatment?: "inherit" | "plain" | "framed" | "slab" | "scrim" | "tint";
  marquee?: boolean;
  surface?: "light" | "tint" | "dark" | "saturated" | "image";
  sectionBackgroundImage?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
    hotspot?: SanityImageHotspot;
...
export type DesignSettings = {
  ...
  sectionJoin?:
    ...
    | "wave"
    | "peak";
  dividerCarry?: Array<string>;
  brandGhost?: "none" | "on";
  sectionOverlap?: "none" | "photo";
  sectionGradient?: "none" | "deep";
  dropCap?: "none" | "on";
  logoOnLight?: {
    asset?: SanityImageAssetReference;
    media?: unknown;
  ...
  imageFrame?: "plain" | "framed" | "slab";
  cardHover?:
    "imageZoom" | "lift" | "glow" | "accentBorder" | "accentUnderline" | "none";
  attorneyCardStyle?:
    "classic" | "portrait" | "avatar" | "minimal" | "spotlight";
...
// Query: *[_type == "designSettings"][0]{    uiRadius,    buttonShape,    buttonAnimation,    tertiaryStyle,    taglineStyle,    elevationStyle,    motionTempo,    marketingScale,    fontPairingPreset,    // The four color roles (Phase 14). The five fields they replace stay in the    // schema, hidden, for one pin, and nothing reads them. Every field of this    // type either appears in this projection or is on the allow-list of the    // projection key-set test beside this file, which fails otherwise.    darkGround,    lightGround,    accent,    action,    internalHeroBackground,    heroScrimOpacity,    // The texture a Pattern section wears (Phase 16A). Absent means none.    //    // KEEP THIS COMMENT PLAIN, and see BI/runbooks/traps.md for why: a backtick    // closes the template literal this query sits in, and several ordinary words    // make the template blank-slate guard flag older field names once the    // generated types are regenerated, which surfaces on CI rather than before.    patternTexture,    // The theme: the flow of the page (Phase 17B). One stored id the site reads at    // render; absent renders the platform default. The only stored design choice the    // site reads by name.    flow,    // The hero photograph the Photo scrims theme was approved with (Phase 17B session 6):    // its photo sections draw only while the live hero photograph is this one.    flowPhoto,    // The style set's settings (Phase 16B): a style set in the Studio writes them with    // the fields above. The site never reads which style set it is.    // patternGround, sectionJoin, dividerCarry, brandGhost, sectionOverlap and    // sectionGradient are retired to the theme layer (Phase 17B) and hidden for one    // pin: the compat bridge reads them from here so a client that stores them    // renders as before until Apply writes the theme.    patternGround,    headingEmphasisStyle,    headingRule,    headingCase,    imageFrame,    sectionJoin,    cardHover,    attorneyCardStyle,    // Phase 16C: the divider's shape and the pieces that repeat it, the heading line's    // design and the display headings' weight.    dividerCarry,    headingWeight,    // Phase 16D: the mark drawn large and quiet behind one band, and the drop cap.    brandGhost,    dropCap,    sectionOverlap,    sectionGradient,    "siteHeroBackgroundImage": siteHeroBackgroundImage{      "src": asset->url,      "alt": alt,      "fit": fit,      "width": asset->metadata.dimensions.width,      "height": asset->metadata.dimensions.height    },    "siteHeroForegroundImage": siteHeroForegroundImage{      "src": asset->url,      "alt": alt,      "hotspot": hotspot{x, y},      "width": asset->metadata.dimensions.width,      "height": asset->metadata.dimensions.height    },    // WS-Sidebar Phase 2.1 — sidebar UI element settings. Behavior wired in    // Phase 2.5; resolver in lib/designTokens.ts (resolveSidebarDesignSettings).    sidebarNavIconStyle,    sidebarWidgetHeaderLine,    sidebarItemSeparators,    "headingFont": customFonts.headingFont{      name,      variable,      "regular":   regular.asset->url,      "bold":      bold.asset->url,      "italic":    italic.asset->url,    },    "bodyFont": customFonts.bodyFont{      name,      variable,      "regular":   regular.asset->url,      "semibold":  semibold.asset->url,      "bold":      bold.asset->url,      "italic":    italic.asset->url,      "boldItalic": boldItalic.asset->url,    },  }
export type DESIGN_TOKENS_QUERY_RESULT = {
  ...
  headingRule:
    ...
    | "zigzag"
    | null;
  headingCase: "normal" | "upper" | null;
  imageFrame: "framed" | "plain" | "slab" | null;
  sectionJoin:
    | "angled"
    | "angledAlternating"
    | "arc"
  ...
  sectionGradient: "deep" | "none" | null;
  siteHeroBackgroundImage: {
    src: string | null;
    alt: string | null;
    fit: "cover" | "tile" | null;
...
export type HOME_QUERY_RESULT = {
  ...
  canvas: Array<
    ...
    | {
        ...
        imageTreatment:
          "framed" | "inherit" | "plain" | "scrim" | "slab" | "tint" | null;
        body: Array<{
          _type: "block";
          _key: string;
          style: "normal" | null;
...
export type EVENT_INDEX_PAGE_QUERY_RESULT = {
  ...
  sections: Array<
    | {
        ...
        media: null;
        appearance: {
          surface: "dark" | "image" | "light" | "tint" | null;
          spacing: "compact" | "normal" | "spacious" | null;
          inset: boolean | null;
          overlapPrevious: "large" | "none" | "small" | null;
          backgroundImage: {
    ...
    | {
        ...
        appearance: {
          surface: "dark" | "image" | "light" | "saturated" | "tint" | null;
          spacing: "compact" | "normal" | "spacious" | null;
          inset: boolean | null;
          overlapPrevious: "large" | "none" | "small" | null;
          backgroundImage: {
...
// Source: ../site/lib/sanity/queries.ts
// Variable: PREVIEW_STORED_DESIGN_QUERY
// Query: *[_type == "designSettings"][0]
export type PREVIEW_STORED_DESIGN_QUERY_RESULT = {
  _id: string;
  _type: "designSettings";
  _createdAt: string;
  _updatedAt: string;
  ...
  tertiaryStyle?: "plain" | "tracked";
  elevationStyle?: "0" | "1" | "2" | "4" | "6";
  imageFrame?: "framed" | "plain" | "slab";
  cardHover?:
    "accentBorder" | "accentUnderline" | "glow" | "imageZoom" | "lift" | "none";
  attorneyCardStyle?:
    "avatar" | "classic" | "minimal" | "portrait" | "spotlight";
  sidebarNavIconStyle?: "arrows" | "chevrons" | "none";
  sidebarWidgetHeaderLine?: boolean;
  sidebarItemSeparators?: boolean;
  motionTempo?: "balanced" | "relaxed" | "snappy";
  profileLayout?:
    "classicSidebar" | "featureGrid" | "premiumHorizontal" | "splitHero";
  profileCtaLabel?: string;
  profileCtaUrl?: string;
} | null;
...
declare global {
  interface SanityQueries {
    ...
    '*[_type == "designSettings"][0]': PREVIEW_STORED_DESIGN_QUERY_RESULT;
  }
}
