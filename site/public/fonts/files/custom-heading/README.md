...
A custom heading font is uploaded in the Studio (Design Settings, Custom Fonts, Heading Font). Its files are
...
Name uploads plainly, for example `CustomFontName-Regular.woff2`, and `-Bold` and `-Italic`. A committed pairing's files live in their own folders beside this
