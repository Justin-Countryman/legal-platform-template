...
const REGISTRY: readonly Row[] = [
  ...
  },
  {
    ...
    marks: ['bg-action ring-1 ring-action-state-cue', 'aria-current', 'bg-border-control'],
  ...
  },
  {
    ...
    marks: ['bg-action text-action-fg ring-1 ring-action-state-cue'],
  ...
  },
  {
    ...
    marks: ['role="tab"', 'bg-action text-action-fg ring-1 ring-action-state-cue'],
  ...
  },
  {
    ...
    marks: ['aria-current', "border-accent bg-accent/10 font-semibold text-foreground"],
