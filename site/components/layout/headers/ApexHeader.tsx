...
// Right column row 1: phone tagline + phone — right-aligned.
// Right column row 2: nav links + optional primary CTA — right-aligned.
// Thin border between the two right-column rows — does NOT cross under the logo.
...
import {
  ...
  isDarkSurfaceScheme,
  secondPhone, HeaderLogo, TopBar, CtaButtons, NavLinks, MobileDrawer, MobileHeaderRow,
  type HeaderData,
} from './shared'

type Props = {data: HeaderData}

export function ApexHeader({data}: Props) {
  const {
          ...
          >
            ...
            <div className="min-w-0 flex flex-col">
              ...
              <div
                ...
                className={`flex flex-col items-end justify-center gap-0.5 overflow-hidden pr-1 transition-[max-height,opacity,padding] duration-structural-slow ease-balanced ${
                  hideSupplementary
