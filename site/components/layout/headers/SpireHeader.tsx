...
// Right column: large dominant phone number top | nav secondary below.
// Phone is the hero element — displayed large, right-aligned.
// Top bar optional (location info left / CTA text right).
// On scroll: phone compresses to inline size, nav persists.
          ...
          >
            ...
            <div className="min-w-0 flex flex-col">
              ...
              <div
                ...
                className={`flex items-end justify-end gap-5 overflow-hidden pr-1 transition-[max-height,opacity,padding] duration-structural-slow ease-balanced ${
                  hideSupplementary
