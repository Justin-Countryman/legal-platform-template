...
export const SECTION_HEADER_H2_CLASS: Record<SectionHeaderScale, string> = {
  ...
  lg: 'mb-5 text-3xl font-bold text-foreground md:text-4xl lg:text-5xl section-heading',
  ...
  xl: 'mb-5 text-4xl font-bold text-foreground md:mb-6 md:text-5xl section-heading',
}
