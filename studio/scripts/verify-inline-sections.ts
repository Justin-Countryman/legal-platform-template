...
NO_SEED.push(
  ['mainNavigation', 'defaultScheme', 'the theme decides it (Phase 17B session 4)'],
  ['mainNavigation', 'scrolledScheme', 'the theme decides it (Phase 17B session 4)'],
  ['footerSettings', 'footerScheme', 'the theme decides it (Phase 17B session 4)'],
)
