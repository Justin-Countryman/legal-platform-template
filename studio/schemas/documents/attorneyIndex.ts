...
export const attorneyIndex = defineType({
  name: 'attorneyIndex',
  title: 'Attorney Index',
  type: 'document',
  fieldsets: [
    {
      name: 'seo',
  ...
  fields: [
    {
      ...
      title: 'Page Title',
      type: 'string',
      description: 'Internal label for this page — e.g. "Our Attorneys"',
    ...
    // ─── Attorney Order ───────────────────────────────────────────────────────
    {
      name: 'orderedAttorneys',
      title: 'Attorney Order',
      type: 'array',
      description: 'Drag to reorder. Attorneys not listed here will appear after in alphabetical order.',
  ...
  preview: {
    ...
    prepare({subtitle}) {
      ...
      return {title: derived ?? 'Attorney Index', subtitle: subtitle ? `/${subtitle}` : ''}
    },
  },
})
